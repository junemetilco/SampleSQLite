...
- (void)viewDidLoad {
	...
	uiTableView = [[UITableView alloc] initWithFrame:CGRectMake(0,5,refFrame.size.width+paddingRight, (animationType == BOTH || animationType == BLENDIN)?heightTableView:1) style:UITableViewStylePlain];
